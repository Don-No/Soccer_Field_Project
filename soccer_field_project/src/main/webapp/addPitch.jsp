									...
									<div class="table-responsive">
										...
										<form action="addPitch" method="post">
											<div class="form-group">
												<label for="pitchPrice">Price:</label> <input type="text"
													class="form-control" id="pitchPrice" name="pitchPrice"
													required>
											</div>
											<div class="form-group">
												<label for="pitchType">Type:</label> <input
													type="text" class="form-control" id="pitchType"
													name="pitchType" required>
											</div>
											<div class="form-group">
												<label for="pitchImage">Image:</label> <input type="file"
													name="pitchImage" class="form-control-file"
													id="pitchImage" required>
											</div>
